          ...
          <article>
            <div className="detailLux">
              <p>
                ...
                seinem Ver- lauf verschiedene Wanderhighlights. Sie kön- nen den
                Trail problemlos in weniger oder mehr als 10 Etappen erwandern.
                Durch die verschie- denen Ein- und Ausstiegsmöglichkeiten kön-
                nen Sie ihr eigenes Abenteuer flexibel planen.
              </p>
              <p>
                ...
                besonderen tou- ristischen Produkt wird für das es sich lohnt
                die Südregion zu besuchen.
              </p>
              <p>
                ...
                also über die Zeit der Minett Trail der zusätz- lich in den 11
                Esch 2022 Gemeinden außer- gewöhnliche Schlafmöglichkeiten
                bieten soll – in ehemaligen Industriegemäuern, leerste- henden
                Hütten usw. Die 11 Herbergen sollten zu architektonischen
                Kunstwerken werden.
              </p>
              <p>
            ...
            <div className="detailFrench">
              <p>
                ...
                Vous pou- vez parcourir le Minett Trail selon vos envies, y
                compris en prévoyant moins ou plus de dix étapes. Comme le
                sentier propose plusieurs points de départ et d’arrivée, vous
                pouvez pla- nifier votre aventure comme vous le souhaitez.
              </p>
              <p>
                L'idée du trail a été élaboré dans le cadre de la candidature au
                label de la « Minett Unesco biosphere » (MUB). L'un des
                principaux objec- tifs était de préparer et de mettre en scène
                nos paysages naturels exceptionnels et notre patrimoine
                industriel de manière à en faire un produit touristique
                particulier pour lequel il vaut la peine de visiter la région du
                sud.
              </p>
              <p>
                Dans la perspective d'Esch 2022, Capitale européenne de la
                Culture, l'occasion s'est pré- sentée de penser plus grand!
              </p>
              <p>
                ...
                dans les 11 communes d'Esch 2022 - dans d'anciens bâti- ments
                industriels, des usines vides, etc. Les 11 gîtes ont vocation à
                devenir des œuvres d'art architecturales.
              </p>
              <p>
                L'objectif était d’accueillir les premiers ran- donneurs dans
                les « Kabaisercher » à partir de 2022 pour qu’ils puissent se
            ...
            <div className="detailEnglish">
              <p>
                ...
                easily hike the Minett Trail by dividing your walk into appro-
                ximately ten stages. The numerous points of entry to the paths
                allow for great flexibility when you plan your adventure.
              </p>
              <p>
                The ‘Minett Trail’ was planned as part of the region’s
                application for the ‘Minett UNESCO Biosphere’ (MUB) label. One
                of its main objecti- ves was to showcase the extraordinary
                natural landscapes and industrial heritage of the south of
                Luxembourg to make it appealing to visitors.
              </p>
              <p>
                However, seeing the wealth of opportunity in the fact that Esch
                was to be the European Capi- tal of Culture in 2022, we decided
                to go bey- ond designing a basic hiking route to imple- ment
                novel ideas.
              </p>
              <p>
                As a result, original accommodation opportu- nities were created
